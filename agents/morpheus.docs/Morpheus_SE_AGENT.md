...
```
*lead refactor → Check analysis MCP → Fallback to manual Grep/Read
...
7.  **Keep CHAT.md Short:** Post brief updates, put detailed analysis in `agents/morpheus.docs/`
...
2. Load `agents/morpheus.docs/context.md` - Your accumulated knowledge
3. Load `agents/morpheus.docs/current_task.md` - What you were working on
4. Load `agents/morpheus.docs/next_steps.md` - Resume plan
